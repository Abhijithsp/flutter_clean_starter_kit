          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: const Color(0xFF2874F0).withValues(alpha: 0.12),
              ),
            ),
          ),
          Positioned(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                AnimatedFadeSlide(
                                  ...
                                  child: Text(
                                    'Login to access your premium store account',
                                    style: GoogleFonts.outfit(
                                      fontSize: 13,
                                ...
                                AnimatedFadeSlide(
                                  ...
                                  child: AppTextField(
                                    ...
                                    focusedBorderColor: const Color(0xFF2874F0),
                                  ),
                                ),
                                ...
                                AnimatedFadeSlide(
                                  ...
                                  child: Align(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        AppSnackbar.show(context, message: 'Password reset link sent to your email (simulated)');
                                      },
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      gradient: const LinearGradient(
                                        colors: [Color(0xFF2874F0), Color(0xFF1E5BB8)],
                                      ),
                                      boxShadow: [
                                        BoxShadow(
                                          color: const Color(0xFF2874F0).withValues(alpha: 0.24),
                                          blurRadius: 8,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          _buildSocialButton(
                                            ...
                                            label: 'Google',
                                            onTap: () {
                                              AppSnackbar.show(context, message: 'Google sign in (simulated)');
                                            },
                                            isDark: isDark,
                                          ),
                                          ...
                                          _buildSocialButton(
                                            ...
                                            label: 'Apple',
                                            onTap: () {
                                              AppSnackbar.show(context, message: 'Apple sign in (simulated)');
                                            },
                                            isDark: isDark,
                                          ),
                                        ],
